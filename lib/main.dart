...
import 'presentation/screens/fonts_download/fonts_download_screen.dart';
...
void main() async {
  ...
  runApp(MathaniApp(showFontsDownload: !areFontsDownloaded));
}

class MathaniApp extends StatelessWidget {
  final bool showFontsDownload;
  
  const MathaniApp({
    Key? key,
    required this.showFontsDownload,
  }) : super(key: key);
      ...
      child: Consumer<SettingsProvider>(
        builder: (context, settings, _) {
          return MaterialApp(
            ...
            home: showFontsDownload 
                ? const FontsDownloadScreen()
                : const SplashScreen(),
